<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorPage.aspx.cs" Inherits="p7.ErrorPage" %>
...
<head runat="server">
    ...
    <style>
        ...
        #x34-gauche, #x34-droite, #ombre-loupe, #decorations {
            opacity: 0;
        }

        #x34-gauche, #x34-droite {
...
<g id="loupe">
  ...
  <div style="font-size:30px;font-family:cursive;color:#424242;margin-left:33%;font-weight:bold" class="error__subtitle">Hmmm...</div>
  <div class="error__description" style="font-size:30px;font-family:cursive;color:#424242;margin-left:33%;font-weight:bold">It looks like one of the  developers fell asleep</div><br />
  <button style="margin-left:33%;height:50px;width:120px;color:white;background-color:#424242;border:solid 0px white;border-radius:15px">Home</button>
